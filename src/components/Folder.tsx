...
export default function Folder({
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="flex-shrink-0 opacity-0 group-hover:opacity-100 text-red-400 hover:text-red-300 transition-opacity bg-gray-800 rounded-full p-1.5 z-20"
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-sm text-center truncate w-full px-2 transition-colors ${
          isDragOver ? "text-blue-200 font-semibold" : "text-gray-200"
        }`}
        title={folder.name}
      >
